...
/// <summary>
/// Provides an overridable mechanism for releasing unmanaged resources asynchronously or synchronously, without property change notification and without a finalizer
/// </summary>
/// <remarks>
/// Because this class declares no finalizer, disposal will not occur if consumers neglect it; hold unmanaged resources in a <see cref="SafeHandle"/> or derive from <see cref="Disposable"/> instead
/// </remarks>
public abstract class PlainDisposable :
    IAsyncDisposable,
    IDisposable,
    ...
    INotifyDisposing
{
    ...
    protected abstract bool DisposeCore();
