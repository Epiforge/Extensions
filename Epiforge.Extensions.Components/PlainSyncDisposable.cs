...
/// <summary>
/// Provides an overridable mechanism for releasing unmanaged resources synchronously, without property change notification and without a finalizer
/// </summary>
/// <remarks>
/// Because this class declares no finalizer, disposal will not occur if consumers neglect it; hold unmanaged resources in a <see cref="SafeHandle"/> or derive from <see cref="SyncDisposable"/> instead
/// </remarks>
public abstract class PlainSyncDisposable :
    IDisposable,
