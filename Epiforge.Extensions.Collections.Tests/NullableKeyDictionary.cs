...
#pragma warning disable IDE0028 // Simplify collection initialization
        var dictionary = new NullableKeyDictionary<string?, int> { { null, 1 } };
#pragma warning restore IDE0028 // Simplify collection initialization
    ...
    {
        var dictionary = new NullableKeyDictionary<string?, int> { { "one", 1 } };
    ...
    {
        var dictionary = new NullableKeyDictionary<int, string>(new Dictionary<int, string>
        {
            { 1, "one" },
            { 2, "two" },
            { 3, "three" }
    ...
    {
        var dictionary = new NullableKeyDictionary<string, int>(new Dictionary<string, int>
        {
            { "one", 1 },
            { "two", 2 },
            { "three", 3 }
    ...
    public void ConstructionFromNullDictionary() =>
        new NullableKeyDictionary<int, string>((IDictionary<int, string>)null!);
    ...
    {
        var dictionary = new NullableKeyDictionary<string, int>(5, StringComparer.OrdinalIgnoreCase);
        Assert.AreSame(StringComparer.OrdinalIgnoreCase, dictionary.Comparer);
    }
    ...
    {
        var dictionary = new NullableKeyDictionary<string, int>(StringComparer.OrdinalIgnoreCase);
        Assert.AreSame(StringComparer.OrdinalIgnoreCase, dictionary.Comparer);
    }
...
#pragma warning restore IDE0028 // Simplify collection initialization
    ...
    [TestMethod]
    public void TrimExcessToCapacity()
    {
        var dictionary = new NullableKeyDictionary<string?, int> { { "one", 1 } };
