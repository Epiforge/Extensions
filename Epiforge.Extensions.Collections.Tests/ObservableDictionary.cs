...
public class ObservableDictionary
{
        ...
        where TKey : notnull
    {
        ...
        public DerivationWithGetDictionaryEnumerator(IDictionary<TKey, TValue> dictionary) :
            base(dictionary)
        {
        }

        public DerivationWithGetDictionaryEnumerator(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
            base(dictionary, comparer)
        {
        }

        public DerivationWithGetDictionaryEnumerator(IEqualityComparer<TKey> comparer) :
            base(comparer)
        {
        }

        public DerivationWithGetDictionaryEnumerator(int capacity) :
            base(capacity)
        {
        }

        public DerivationWithGetDictionaryEnumerator(int capacity, IEqualityComparer<TKey> comparer) :
        ...
        where TKey : notnull
    {
        ...
        public DerivationWithNullOnChangedArgs(IDictionary<TKey, TValue> dictionary) :
            base(dictionary)
        {
        }

        public DerivationWithNullOnChangedArgs(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
            base(dictionary, comparer)
        {
        }

        public DerivationWithNullOnChangedArgs(IEqualityComparer<TKey> comparer) :
            base(comparer)
        {
        }

        public DerivationWithNullOnChangedArgs(int capacity) :
            base(capacity)
        {
        }

        public DerivationWithNullOnChangedArgs(int capacity, IEqualityComparer<TKey> comparer) :
            base(capacity, comparer)
        {
        }
        ...
        where TKey : notnull
    {
        ...
        public DerivationWithUnsupportedNotifyDictionaryChangedAction(IDictionary<TKey, TValue> dictionary) :
            base(dictionary)
        {
        }

        public DerivationWithUnsupportedNotifyDictionaryChangedAction(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
            base(dictionary, comparer)
        {
        }

        public DerivationWithUnsupportedNotifyDictionaryChangedAction(IEqualityComparer<TKey> comparer) :
            base(comparer)
        {
        }

        public DerivationWithUnsupportedNotifyDictionaryChangedAction(int capacity) :
            base(capacity)
        {
        }

        public DerivationWithUnsupportedNotifyDictionaryChangedAction(int capacity, IEqualityComparer<TKey> comparer) :
            base(capacity, comparer)
        {
        }
