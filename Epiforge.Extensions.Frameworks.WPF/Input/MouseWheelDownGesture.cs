namespace Epiforge.Extensions.Frameworks.WPF.Input;
    ...
    MouseGesture
{
    ...
    public override bool Matches(object targetElement, InputEventArgs inputEventArgs) =>
        base.Matches(targetElement, inputEventArgs) && inputEventArgs is MouseWheelEventArgs mouseWheelEventArgs && mouseWheelEventArgs.Delta < 0;
}
