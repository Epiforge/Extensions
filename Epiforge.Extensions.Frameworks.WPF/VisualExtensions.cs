...
public static class VisualExtensions
{
    ...
    public static T? GetVisualAncestor<T>(this DependencyObject reference)
    ...
    /// <param name="reference">The reference in the Visual Tree from which to begin searching</param>
    public static DependencyObject? GetVisualAncestor<T1, T2>(this DependencyObject reference)
    ...
    /// <param name="reference">The reference in the Visual Tree from which to begin searching</param>
    public static DependencyObject? GetVisualAncestor<T1, T2, T3>(this DependencyObject reference)
        where T1 : DependencyObject
        where T2 : DependencyObject
        where T3 : DependencyObject
    {
#if IS_NET_6_0_OR_GREATER
        ArgumentNullException.ThrowIfNull(reference);
#else
    ...
    /// <param name="reference">The reference in the Visual Tree from which to begin searching</param>
    public static T? GetVisualDescendent<T>(this DependencyObject reference)
        where T : DependencyObject
    {
#if IS_NET_6_0_OR_GREATER
        ArgumentNullException.ThrowIfNull(reference);
    ...
    public static T? GetVisualDescendent<T>(this DependencyObject reference, Func<T, bool> predicate)
        where T : DependencyObject
    {
#if IS_NET_6_0_OR_GREATER
        ArgumentNullException.ThrowIfNull(reference);
