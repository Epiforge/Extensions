...
/// <summary>
/// Converts the value to <see cref="Visibility.Hidden"/> when equal to zero; otherwise, <see cref="Visibility.Visible"/>
/// </summary>
...
public sealed class ZeroIsHiddenValueConverter :
    IValueConverter
{
    /// <summary>
    /// Converts a value
    ...
    /// <summary>
    /// Gets a shared instance of <see cref="ZeroIsCollapsedValueConverter"/>
    /// </summary>
    public static ZeroIsHiddenValueConverter Default { get; } = new ZeroIsHiddenValueConverter();
}
