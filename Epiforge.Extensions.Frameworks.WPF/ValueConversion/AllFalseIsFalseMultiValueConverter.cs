...
/// <summary>
/// Converts the values to <c>false</c> when all of them are <c>false</c> or not a <see cref="bool"/>; otherwise, to <c>true</c>
/// </summary>
public sealed class AllFalseIsFalseMultiValueConverter :
    IMultiValueConverter
{
    ...
    /// <summary>
    /// Gets a shared instance of <see cref="AllFalseIsFalseMultiValueConverter"/>
    /// </summary>
    public static AllFalseIsFalseMultiValueConverter Default { get; } = new AllFalseIsFalseMultiValueConverter();
}
