...
public sealed class NotZeroIsFalseValueConverter :
    IValueConverter
{
    /// <summary>
    /// Converts a value
    ...
    /// <summary>
    /// Gets a shared instance of <see cref="NotZeroIsFalseValueConverter"/>
    /// </summary>
    public static NotZeroIsFalseValueConverter Default { get; } = new NotZeroIsFalseValueConverter();
}
