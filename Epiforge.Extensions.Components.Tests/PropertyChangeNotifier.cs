...
public class PropertyChangeNotifier
{
    ...
    public void PropertyChanges()
    {
        ...
        logger.ReceivedLogTrace("Raising PropertyChanging event for property \"Text\"");
        logger.ReceivedLogTrace("Raised PropertyChanging event for property \"Text\"");
        logger.ReceivedLogTrace("Raising PropertyChanged event for property \"Text\"");
        logger.ReceivedLogTrace("Raised PropertyChanged event for property \"Text\"");
        logger.ClearReceivedCalls();
        derivation.NullableText = "Suprise!";
        logger.ReceivedLogTrace("\"NullableText\" property is changing from \"(null)\" to \"Suprise!\"");
        logger.ReceivedLogTrace("Raising PropertyChanging event for property \"NullableText\"");
        logger.ReceivedLogTrace("Raised PropertyChanging event for property \"NullableText\"");
        logger.ReceivedLogTrace("Raising PropertyChanged event for property \"NullableText\"");
        logger.ReceivedLogTrace("Raised PropertyChanged event for property \"NullableText\"");
        logger.ClearReceivedCalls();
    ...
    public void PropertyChangesWithoutIn()
    {
        ...
        logger.ReceivedLogTrace("Raising PropertyChanging event for property \"TextWithoutIn\"");
        logger.ReceivedLogTrace("Raised PropertyChanging event for property \"TextWithoutIn\"");
        logger.ReceivedLogTrace("Raising PropertyChanged event for property \"TextWithoutIn\"");
        logger.ReceivedLogTrace("Raised PropertyChanged event for property \"TextWithoutIn\"");
        logger.ClearReceivedCalls();
        ...
        logger.ReceivedLogTrace("Raising PropertyChanging event for property \"NullableTextWithoutIn\"");
        logger.ReceivedLogTrace("Raised PropertyChanging event for property \"NullableTextWithoutIn\"");
        logger.ReceivedLogTrace("Raising PropertyChanged event for property \"NullableTextWithoutIn\"");
        logger.ReceivedLogTrace("Raised PropertyChanged event for property \"NullableTextWithoutIn\"");
        logger.ClearReceivedCalls();
