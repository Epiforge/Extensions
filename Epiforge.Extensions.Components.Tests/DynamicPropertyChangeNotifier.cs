...
public class DynamicPropertyChangeNotifier
{
    ...
    public void PropertyChanges()
    {
        ...
        logger.ReceivedLogTrace("Text property is changing from text to other text");
        logger.ReceivedLogTrace("Raising PropertyChanging event for Text property");
        logger.ReceivedLogTrace("Raised PropertyChanging event for Text property");
        logger.ReceivedLogTrace("Raising PropertyChanged event for Text property");
        logger.ReceivedLogTrace("Raised PropertyChanged event for Text property");
        logger.ClearReceivedCalls();
        derivation.NullableText = "Suprise!";
        logger.ReceivedLogTrace("NullableText property is changing from (null) to Suprise!");
        logger.ReceivedLogTrace("Raising PropertyChanging event for NullableText property");
        logger.ReceivedLogTrace("Raised PropertyChanging event for NullableText property");
        logger.ReceivedLogTrace("Raising PropertyChanged event for NullableText property");
        logger.ReceivedLogTrace("Raised PropertyChanged event for NullableText property");
        logger.ClearReceivedCalls();
        derivation.NullableText = null;
        logger.ReceivedLogTrace("NullableText property is changing from Suprise! to (null)");
        logger.ReceivedLogTrace("Raising PropertyChanging event for NullableText property");
        logger.ReceivedLogTrace("Raised PropertyChanging event for NullableText property");
        logger.ReceivedLogTrace("Raising PropertyChanged event for NullableText property");
        logger.ReceivedLogTrace("Raised PropertyChanged event for NullableText property");
    ...
    public void PropertyChangesWithoutIn()
    {
        ...
        logger.ReceivedLogTrace("TextWithoutIn property is changing from text to other text");
        logger.ReceivedLogTrace("Raising PropertyChanging event for TextWithoutIn property");
        logger.ReceivedLogTrace("Raised PropertyChanging event for TextWithoutIn property");
        logger.ReceivedLogTrace("Raising PropertyChanged event for TextWithoutIn property");
        logger.ReceivedLogTrace("Raised PropertyChanged event for TextWithoutIn property");
        logger.ClearReceivedCalls();
        derivation.NullableTextWithoutIn = "Suprise!";
        logger.ReceivedLogTrace("NullableTextWithoutIn property is changing from (null) to Suprise!");
        logger.ReceivedLogTrace("Raising PropertyChanging event for NullableTextWithoutIn property");
        logger.ReceivedLogTrace("Raised PropertyChanging event for NullableTextWithoutIn property");
        logger.ReceivedLogTrace("Raising PropertyChanged event for NullableTextWithoutIn property");
        logger.ReceivedLogTrace("Raised PropertyChanged event for NullableTextWithoutIn property");
        logger.ClearReceivedCalls();
        derivation.NullableTextWithoutIn = null;
        logger.ReceivedLogTrace("NullableTextWithoutIn property is changing from Suprise! to (null)");
        logger.ReceivedLogTrace("Raising PropertyChanging event for NullableTextWithoutIn property");
        logger.ReceivedLogTrace("Raised PropertyChanging event for NullableTextWithoutIn property");
        logger.ReceivedLogTrace("Raising PropertyChanged event for NullableTextWithoutIn property");
        logger.ReceivedLogTrace("Raised PropertyChanged event for NullableTextWithoutIn property");
