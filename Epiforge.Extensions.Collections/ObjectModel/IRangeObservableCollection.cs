...
public interface IRangeObservableCollection<T> :
    ICollection,
    ICollection<T>,
    IEnumerable,
    IEnumerable<T>,
...
{
    /// <summary>
    /// Adds objects to the end of the <see cref="IRangeObservableCollection{T}"/>
    /// </summary>
    /// <param name="items">The objects to be added to the end of the <see cref="IRangeObservableCollection{T}"/></param>
    ...
    /// <summary>
    /// Removes all object from the <see cref="IRangeObservableCollection{T}"/> that satisfy the <paramref name="predicate"/>
    /// </summary>
    /// <param name="predicate">A predicate used to determine whether to remove an object from the <see cref="IRangeObservableCollection{T}"/></param>
    /// <returns>The items that were removed</returns>
    IReadOnlyList<T> GetAndRemoveAll(Func<T, bool> predicate);

    /// <summary>
    /// Gets the element at the specified index and removes it from the <see cref="IRangeObservableCollection{T}"/>
    /// </summary>
    ...
    /// <summary>
    /// Inserts elements into the <see cref="IRangeObservableCollection{T}"/> at the specified index
    /// </summary>
    ...
    /// <summary>
    /// Removes the specified items from the <see cref="IRangeObservableCollection{T}"/>
    /// </summary>
    ...
    /// <summary>
    /// Removes the specified range of items from the <see cref="IRangeObservableCollection{T}"/>
    /// </summary>
    ...
    /// <summary>
    /// Replace all items in the <see cref="IRangeObservableCollection{T}"/> with the items in the specified collection
    /// </summary>
    ...
    /// <summary>
    /// Replaces the specified range of items from the <see cref="IRangeObservableCollection{T}"/> with the items in the specified collection
    /// </summary>
    /// <param name="index">The index of the first item in the range</param>
    /// <param name="count">The number of items in the range</param>
    ...
    /// <summary>
    /// Replaces the specified range of items from the <see cref="IRangeObservableCollection{T}"/> with the items in the specified list
    /// </summary>
    /// <param name="index">The index of the first item in the range</param>
    /// <param name="count">The number of items in the range</param>
    ...
    /// <summary>
    /// Resets the <see cref="IRangeObservableCollection{T}"/> with the specified collection of items
    /// </summary>
