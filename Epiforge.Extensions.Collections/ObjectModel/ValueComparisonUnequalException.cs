    ...
    Exception
{
    ...
    /// </summary>
    public ValueComparisonUnequalException() :
        base("the oldValue and comparisonValue are unequal")
    {
    }
    ...
    public ValueComparisonUnequalException(string message) :
        base(message)
    {
    }
    ...
    public ValueComparisonUnequalException(string message, Exception innerException) :
